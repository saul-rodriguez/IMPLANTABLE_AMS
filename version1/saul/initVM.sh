...
###########################
export AMS_DIR=/pkg/AMS
export PATH=$PATH:$AMS_DIR/cds/bin:$AMS_DIR/programs/bin
#export PATH=$PATH:$AMS_DIR/cds/bin:$AMS_DIR/programs/bin

#export CDSHOME=/pkg/Cadence/installs/IC615_500_171
...
##################################
#export MMSIM_HOME=/pkg/Cadence/installs/MMSIM101
#export MMSIM_HOME=/pkg/Cadence/installs/MMSIM121
...
#export INSISIVE=/pkg/Cadence/installs/INCISIVE142
...
# RC RTL Compiler #
###################
export RTL_HOME=/pkg/Cadence/installs/RC141
